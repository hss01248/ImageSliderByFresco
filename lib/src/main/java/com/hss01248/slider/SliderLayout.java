...
import com.hss01248.slider.SliderTypes.DefaultSliderView;
import com.hss01248.slider.SliderTypes.TextSliderView;
import com.hss01248.slider.Transformers.AccordionTransformer;
import com.hss01248.slider.Transformers.BackgroundToForegroundTransformer;
import com.hss01248.slider.Transformers.BaseTransformer;
import com.hss01248.slider.Transformers.CubeInTransformer;
import com.hss01248.slider.Transformers.DefaultTransformer;
import com.hss01248.slider.Transformers.DepthPageTransformer;
import com.hss01248.slider.Transformers.FadeTransformer;
import com.hss01248.slider.Transformers.FlipHorizontalTransformer;
import com.hss01248.slider.Transformers.FlipPageViewTransformer;
import com.hss01248.slider.Transformers.ForegroundToBackgroundTransformer;
import com.hss01248.slider.Transformers.RotateDownTransformer;
import com.hss01248.slider.Transformers.RotateUpTransformer;
import com.hss01248.slider.Transformers.StackTransformer;
import com.hss01248.slider.Transformers.TabletTransformer;
import com.hss01248.slider.Transformers.ZoomInTransformer;
import com.hss01248.slider.Transformers.ZoomOutSlideTransformer;
import com.hss01248.slider.Transformers.ZoomOutTransformer;
import com.hss01248.slider.Tricks.FixedSpeedScroller;
import com.hss01248.slider.Tricks.InfinitePagerAdapter;
import com.hss01248.slider.Tricks.InfiniteViewPager;
...
public class SliderLayout extends RelativeLayout {
    ...
    public void refreshSlider(List<SliderInfo> datas, BaseSliderView.OnSliderClickListener listener) {

        //先清除map中失效的旧图
        //如果本地数据有，而服务器新数据删掉了该条呢？

        Iterator<Map.Entry<String, BaseSliderView>> it = sliderViews.entrySet().iterator();
        while(it.hasNext()){
            Map.Entry<String, BaseSliderView> entry=it.next();
            ...
            if (!isContains){//如果不包含，就移除这个view
                it.remove();//移除map
                SliderAdapter sliderAdapter = getRealAdapter();
                sliderAdapter.removeSlider(entry.getValue());
            }
        }
...
//然后是添加或更新
        ...
        for (SliderInfo info : datas){
            if (sliderViews.get(info.imageUrl) == null){//如果集合中没有，就添加
                ...
                BaseSliderView textSliderView = null;
                if (TextUtils.isEmpty(info.desc) || info.desc.matches("\\s+")){//无标题的，不加黑色
